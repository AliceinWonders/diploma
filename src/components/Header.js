  ...
  return(
        <div className="Header">
            <nav>
                ...
                <NavLink  to="/search"><button type="submit" onClick={() => props.mySearchPost(inputContent)}><i class="fa fa-search"></i></button></NavLink> 
                </div>
            </nav>   
        </div>
    )
